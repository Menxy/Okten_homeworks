...
let cindy1 = new Cinderella('Ana', 18, 36);
let cindy2 = new Cinderella('Cindy', 20, 35);
let cindy3 = new Cinderella('Lola', 23, 38);
let cindy4 = new Cinderella('Lena', 17, 32);
let cindy5 = new Cinderella('Carter', 19, 33);
let cindy6 = new Cinderella('Tiffany', 18, 40);
let cindy7 = new Cinderella('Dolores', 25, 39);
let cindy8 = new Cinderella('Rein', 17, 35);
let cindy9 = new Cinderella('Jessica', 19, 36);
let cindy10 = new Cinderella('Zoey', 22, 38);
let cindyArray = [cindy1, cindy2, cindy3, cindy4, cindy5, cindy6, cindy7, cindy8, cindy9, cindy10]*/
...
let prince = new Prince('Alfred', 25, 40)*/
// console.log(prince);
/*let winner;
for (const cindy of cindyArray) {
    if (cindy.footSize === prince.shoe) {
        winner = cindy;
        break
    }
}
...
/*
console.log(cindyArray.find(cindy => cindy.footSize === prince.shoe));*/
